...
{
    public class ManagerSysDbMigrationService
    {
        //public ILogger<ManagerSysDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IManagerSysDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ICurrentTenant _currentTenant;

        public ManagerSysDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IManagerSysDbSchemaMigrator> dbSchemaMigrators,
        ...
        //    catch (Exception e)
        //    {
        //        Log.Warning("Couldn't determinate if any migrations exist : " + e.Message);
        //        return false;
        //    }
        //}
