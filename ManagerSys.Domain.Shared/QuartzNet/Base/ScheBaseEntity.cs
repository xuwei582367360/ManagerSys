...
namespace ManagerSys.Domain.Shared.QuartzNet.Base
{
    ...
    /// by hoho
    /// </summary>
    public abstract class ScheBaseEntity : MarshalByRefObject, IDisposable
    {
        ...
        /// 任务执行的方法，由具体任务去重写实现
        /// </summary>
        public abstract void Run(TaskContext taskContext);
        ...
        /// </summary>
        internal void InnerRun(TaskContext taskContext)
        {
            if (!_isRunning)
            {
                _isRunning = true;
