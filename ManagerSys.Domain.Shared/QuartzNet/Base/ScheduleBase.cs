...
namespace ManagerSys.Domain.Shared.QuartzNet.Base
{
    public abstract class ScheduleBase : MarshalByRefObject, IDisposable
    {
        ...
        /// </summary>
        /// <param name="scheBaseEntity"></param>
        ...
        /// 任务执行的方法，由具体任务去重写实现
        /// </summary>
        public abstract void Run(ScheBaseEntity scheBaseEntity);
        ...
        /// </summary>
        internal void InnerRun(ScheBaseEntity scheBaseEntity)
        {
            if (!_isRunning)
            {
                _isRunning = true;
