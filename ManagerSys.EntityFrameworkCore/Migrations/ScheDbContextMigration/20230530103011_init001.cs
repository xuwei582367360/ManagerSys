        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockedNode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreateUserCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreateUser = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreateTime = table.Column<DateTime>(type: "datetime2", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomParamsJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Node = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessSecret = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    status = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "Assembly_ImagePullPolicy", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3280), null, null, "程序集配置", null, true, "文件包拉取策略", "Always-总是拉取，IfNotPresent-本地没有时拉取，默认是Always", 1, null, null, null, "Always" },
                    { "DelayTask_DelayPattern", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3286), null, null, "延时任务配置", null, true, "延迟模式", "Relative-相对时间，Absolute-绝对时间，默认值是Relative", 1, null, null, null, "Relative" },
                    { "DelayTask_RetrySpans", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3289), null, null, "延时任务配置", null, true, "回调失败重试间隔", "回调失败重试间隔时间(s)，会随着重试次数递增，默认值是10秒", 3, null, null, null, "10" },
                    { "DelayTask_RetryTimes", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3288), null, null, "延时任务配置", null, true, "回调失败重试次数", "回调失败重试次数，默认值是3", 2, null, null, null, "3" },
                    { "Email_FromAccount", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3246), null, null, "邮件配置", null, true, "发件人账号", "邮箱账号", 3, null, null, null, "" },
                    { "Email_FromAccountPwd", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3249), null, null, "邮件配置", null, true, "发件人账号密码", "登录密码或授权码等", 4, null, null, null, "" },
                    { "Email_SmtpPort", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3244), null, null, "邮件配置", null, true, "邮件服务器端口", "smtp端口号", 2, null, null, null, "" },
                    { "Email_SmtpServer", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3227), null, null, "邮件配置", null, true, "邮件服务器", "smtp服务器地址", 1, null, null, null, "" },
                    { "Http_RequestTimeout", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3282), null, null, "HTTP配置", null, true, "请求超时时间", "单位是秒，默认值是10", 1, null, null, null, "10" },
                    { "System_WorkerUnHealthTimes", new DateTime(2023, 5, 30, 18, 30, 11, 676, DateTimeKind.Local).AddTicks(3284), null, null, "系统配置", null, true, "Worker允许无响应次数", "健康检查失败达到最大次数会被下线剔除，默认值是3", 1, null, null, null, "3" }
                });
        }
